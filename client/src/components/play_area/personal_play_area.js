...
const PersonalPlayArea = ({ cards, playerName, playerID, cashSelect, cardSelection}) => {

    return (
        <div>
            {(playerName) ? <h3 className='overall-game-card-heading'>{playerName}</h3> : <h3 className='overall-game-card-heading'>Your Cards</h3>}
            <PropertyView properties={cards.properties} playerID={playerID} cardSelection={cardSelection}/>
